...
export function ChatInfo({isOwnerChannel, isFollower, isSponsor, isChatEnabled, isChatFollowersOnly, isChatPremiumFollowersOnly}: ChatInfoProps) {
    ...
    return <div className="mt-2 flex h-10 w-full items-center gap-x-2 rounded-md border bg-accent px-3 text-muted-foreground">
